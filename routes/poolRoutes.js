...
import{acceptPoolRequest, createPoolRequest, getMyPoolRequests , getAllPoolRequests, rejectPoolRequest} from '../controllers/poolRequestControllers.js'
import {  protect } from '../middlewares/authMiddleware.js'

router.route('/').post(protect, createPool).get(protect, getPools)
router.route('/my').get(protect, getMyPools)
router.route('/:id/requests').post(protect, createPoolRequest).get(protect, getAllPoolRequests)

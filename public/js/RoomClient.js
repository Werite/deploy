...
class RoomClient {
    ...
    exitRoom(token, pool_id) {
        ...
        fetch(`https://localhost:5000/update/usernotincall`, {
        method: 'PATCH',
        headers: {
        ...
        .then((data) => {
            ...
            fetch(`https://localhost:5000/iscurrentpoolempty/${pool_id}`)
        .then((response) => response.json())
        .then((data) => {
            console.log(data.message);
            if (data.message === "Pool Empty") {
                fetch(`https://localhost:5000/join/${pool_id}/0`, {
                    method: 'PATCH',
                    headers: {
                        "Content-Type" : "application/json"
                    }
                    ...
                    .catch((error) => {
                        console.error('Error with pool isactive status update:', error);
                    });
            }
